...
export const MYSTERY_IMAGES: Record<string, MysteryImageDef[]> = {
    ...
    luminous: [
        ...
        { path: '/images/luminous/luminous_3_proclamation.webp', alt: 'The Proclamation of the Kingdom' },
        { path: '/images/luminous/luminous_4_transfiguration.webp', alt: 'The Transfiguration' },
        { path: '/images/luminous/luminous_5_institution.webp', alt: 'The Institution of the Eucharist' }
    ],
    sorrowful: [
