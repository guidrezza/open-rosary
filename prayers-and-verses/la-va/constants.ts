...
export const la_va: LocalizationData = {
	...
	ui: {
		...
		liturgical: {
			...
			// Feasts
			epiphany: 'Epiphania Domini',
			presentation: 'Praesentatio Domini',
			annunciation: 'Annuntiatio Domini',
			transfiguration: 'Transfiguratio Domini',
			assumption: 'Assumptio B.M.V.',
			all_saints: 'Omnium Sanctorum',
			all_souls: 'Omnium Fidelium Defunctorum',
			immaculate_conception: 'Immaculata Conceptio B.M.V.',
			guadalupe: 'B.M.V. de Guadalupe',
			mother_of_god: 'Sancta Dei Genetrix',
			ash_wednesday: 'Feria IV Cinerum',
			palm_sunday: 'Dominica in Palmis',
			holy_thursday: 'Feria V in Cena Domini',
			good_friday: 'Feria VI in Passione Domini',
			holy_saturday: 'Sabbatum Sanctum',
			easter_sunday: 'Dominica Resurrectionis',
			divine_mercy: 'Dominica in Albis',
			ascension: 'Ascensio Domini',
			pentecost: 'Dominica Pentecostes',
			trinity: 'Sanctissima Trinitas',
			...
			gaudete: 'Dominica Gaudete',
			laetare: 'Dominica Laetare',
			st_joseph: 'Sancti Iosephi',
			st_peter_paul: 'Sanctorum Petri et Pauli',
			exaltation_cross: 'Exaltatio Sanctae Crucis',
			archangels: 'Sanctorum Archangelorum',
			lateran_basilica: 'Dedicatio Basilicae Lateranensis',
			holy_family: 'Sanctae Familiae',
			nativity_john_baptist: 'Nativitas Sancti Ioannis Baptistae',
			baptism_lord: 'Baptisma Domini'
		},
		modes: {
			digital: {
