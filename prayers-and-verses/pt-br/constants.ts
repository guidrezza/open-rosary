...
export const pt_br: LocalizationData = {
	...
	seo: {
		title: 'Santo Rosário',
		description:
			'Reze o Terço ou Rosário. Grátis, rápido e para celular. Um app moderno, open source e fácil de usar para sua oração diária.'
	},
	ui: {
		...
		liturgical: {
			...
			lateran_basilica: 'Dedicação de Latrão',
